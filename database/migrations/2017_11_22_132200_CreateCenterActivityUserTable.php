...
class CreateCenterActivityUserTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('center_activity_user', function (Blueprint $table) {
            $table->increments('id')->unsigned();
            $table->integer('caid')->length(10)->unsigned();
    ...
    {
        Schema::drop('center_activity_user');
    }
}
