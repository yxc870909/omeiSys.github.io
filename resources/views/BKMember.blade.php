...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/bk-member-profile.css">
    <title>Login</title>    
</head>
<body>
	...
	<div class="row">
		...
		">
	        ...
	        <div class="row">
	        	...
	        	<div class="col-md-9">
	        		@include('layouts.Main_Member', array($edus, $skills, $positions))
	...
	<script type="text/javascript" src="/js/bk-member.js"></script>
</body>