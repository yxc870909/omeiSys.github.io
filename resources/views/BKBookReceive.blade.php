...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/bk-booksreceive.css">
...
<body>
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
	        ...
	        <div class="row">
	        	...
	        	<div class="col-md-9">
	        		@include('layouts.Main_BooksReceive')
	        	</div>
	        </div>
	...
	<script type="text/javascript" src="/js/bk-booksreceive.js"></script>
</body>