...
<body>
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
	        ...
	        <div class="row">
	        	...
	        	<div class="col-md-9">
	        		@include('layouts.Main_Personnel', array($tabs, $areas, $positions, $works, $groups, $edus, $skills, $lunar_month, $lunar_day, $lunar_hour, $operating))
	        	</div>
	        </div>
		</div>
	</div>
	...
	<script type="text/javascript" src="/js/bk-personnel.js" ></script>
</body>