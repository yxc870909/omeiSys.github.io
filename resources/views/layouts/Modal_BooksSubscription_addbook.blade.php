                ...
                <form class="form-horizontal" name="add_book" enctype="multipart/form-data">
                    ...
                    <div class="panel panel-default col-md-6">
                        <div class="panel-body">                            
                            ...
                            <div class="form-group">
                                <label class="col-md-4">* 訂閱</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="SubscriptionCount" value="" placeholder="輸入數量">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-4">書庫</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="ReceiveCount" value="" placeholder="輸入數量">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-4">圖書館</label>
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="LibraryCount" value="" placeholder="輸入數量">
                                </div>
                            </div>
                            ...
                            <div class="img-box">
                                ...
                                <input type="file" name="reupload" id="upload" style="display: none;">
