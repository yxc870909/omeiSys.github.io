<!--add_temple-->
<div class="modal fade bs-example-modal-lg" id="edit_temple" tabindex="-1" role="dialog" aria-labelledby="mymdallModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">                            
                <form class="form-horizontal" name="doEditTemple" role="form">
                    ...
                    <div class="form-group">
                        <div class="col-md-12" align="right">
                            <button type="button" class="btn btn-success right" name="saveEditTemple" aria-expanded="fales">儲存變更</button>
                        </div>
                    </div>
