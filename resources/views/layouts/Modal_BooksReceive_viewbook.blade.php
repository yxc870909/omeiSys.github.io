<div class="modal fade bs-example-modal-md" id="view_Receivebook" tabindex="-1" role="dialog" aria-labelledby="mymdallModalLabel" aria-hidden="true">
                ...
                <form class="form-horizontal" name="view_book">
                    ...
                    <div class="form-group">
                        <div class="col-md-5">
                            ...
                            <input type="text" class="form-control col-md-10" name="count" placeholder="輸入欲請領數量">
                        </div>
                    ...
                    <div align="right">
                        <button type="button" class="btn btn-success right" name="save" aria-expanded="fales">我要申請請領</button>
                    </div>
