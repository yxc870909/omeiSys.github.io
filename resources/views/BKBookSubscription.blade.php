...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/bk-bookssubscription.css">
...
<body>
	...
	<div class="row">
		<div class="col-md-10 col-md-offset-1">
	        ...
	        <div class="row">
	        	...
	        	<div class="col-md-9">
	        		@include('layouts.Main_BooksSubscription')
	        	</div>
	        </div>
	...
	<script type="text/javascript" src="/js/bk-bookssubscription.js"></script>
</body>